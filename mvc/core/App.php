    ...
    function __construct(){
        ...
        if($arr != null && $arr[0] != "admin"){
            ...
            // Controller
                if(isset($arr[1])){
                    ...
                    if(isset($_SESSION["administration"])){
                        if($_SESSION["administration"] == true){
                            ...
                            if(file_exists("./mvc/controllers/admin-controllers/".$arr[1]."Controller.php")){
                ...
                require_once "./mvc/controllers/admin-controllers/". $this->AdminController ."Controller.php";
